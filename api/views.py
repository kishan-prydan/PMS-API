...
from .serializers import UserSerializer, tblScheduleSerializer, tblUserSerializer, tblEntitySerializer, tblAddressSerializer, tblCompanySerializer, tblCountryCodeSerializer, tblEmailSerializer, tblEntitySocialMediaSerializer, tblPersonSerializer, tblPhoneSerializer, tblEntityPhoneSerializer, tblPhotoSerializer, tblSocialMediaSerializer, tblAllocationSerializer, tblPaymentSerializer, tblBillSerializer, tblProjectSerializer, tblComplaintSerializer, tblFeedbackSerializer, tblUpdateStatusSerializer, tblInquirySerializer, tblProfileSerializer, tblQuatationSerializer, stblUserTypeSerializer, stblEntityTypeSerializer, stblAddressTypeSerializer, stblCompanyTypeSerializer, stblCountryCodeTypeSerializer, stblEmailTypeSerializer, stblPersonTypeSerializer, stblPhoneTypeSerializer, stblPhotoTypeSerializer, stblSocialMediaTypeSerializer, stblSuffixTypeSerializer, stblIndustryTypeSerializer, stblInquiryTypeSerializer, rtblEntityEmailSerializer, rtblEntitySerializer
...
def about(request):
    ...
    # return HttpResponse("Thi is about us page")
...
class EDetailApi(APIView):
	def get(self,request,pk,*args, **kwargs):
		...
		tbl_Entity_address = tblAddress.objects.filter(EntityIDF=tbl_entity)
		if tbl_Entity_address:
			eAddress = []
			for a in tbl_Entity_address:
				tbl_Address_Serializer = tblAddressSerializer(a)	
	...
	def patch(self, request, pk, format=None):
		...
		if tbl_entity.EntityTypeIDF.EntityTypeID == 1:
			...
			if data['UpdateStatus']:
				S = tblUpdateStatus.objects.get(Status=data['Status'])
...
class EntityDetailApi(APIView):
	...
	def post(self,request,format=None):
		...
		if data['FirstName']:
			...
			status_ = tblUpdateStatus.objects.get(Status=data['Status'])
		...
		if data['CompanyName']:
			...
			tblcompany = tblCompany(CompanyName=data['CompanyName'],GSTINNo=data['GSTINNo'],Headquarter=data['Headquarter'],WebsiteURL=data['WebsiteURL'],About=data['About'],Founded=data['Founded'],Specialities=data['Specialities'],AnnualRevenue=data['AnnualRevenue'],CompanyTypeIDF=CompanyType,IndustryIDF=IndustryType,EntityIDF=latest_entity)
			tblcompany.save()
...
class StaticDataApi(ObjectMultipleModelAPIView):
	querylist =[
		...
		{'queryset':tblUpdateStatus.objects.all(),'serializer_class':tblUpdateStatusSerializer, 'label': 'Status'},
...
class tblUserViewSet(viewsets.ModelViewSet):
...
class stblUserTypeViewSet(viewsets.ModelViewSet):
	queryset = stblUserType.objects.all()
	serializer_class = stblUserTypeSerializer
...
class tblInquiryViewSet(viewsets.ModelViewSet):
    queryset = tblInquiry.objects.all()
    serializer_class = tblInquirySerializer			
    filter_backends = [SearchFilter]
    search_fields = ['InquiryID']


class stblInquiryTypeViewSet(viewsets.ModelViewSet):
    queryset = stblInquiryType.objects.all()
    serializer_class = stblInquiryTypeSerializer


class tblAllocationViewSet(viewsets.ModelViewSet):
    queryset = tblAllocation.objects.all()
    serializer_class = tblAllocationSerializer		
    filter_backends = [SearchFilter]
    search_fields = ['LanguageName']


class tblPaymentViewSet(viewsets.ModelViewSet):
    queryset = tblPayment.objects.all()
    serializer_class = tblPaymentSerializer		
    filter_backends = [SearchFilter]
    search_fields = ['PaymentID']


class tblBillViewSet(viewsets.ModelViewSet):
    queryset = tblBill.objects.all()
    serializer_class = tblBillSerializer


class tblProjectViewSet(viewsets.ModelViewSet):
    queryset = tblProject.objects.all()
    serializer_class = tblProjectSerializer	
    filter_backends = [SearchFilter]
    search_fields = ['ProjectName']


class tblComplaintViewSet(viewsets.ModelViewSet):
    queryset = tblComplaint.objects.all()
    serializer_class = tblComplaintSerializer	
    filter_backends = [SearchFilter]
    search_fields = ['ComplaintID']


class tblFeedbackViewSet(viewsets.ModelViewSet):
    queryset = tblFeedback.objects.all()
    serializer_class = tblFeedbackSerializer	
    filter_backends = [SearchFilter]
    search_fields = ['FeedbackID']


class tblScheduleViewSet(viewsets.ModelViewSet):
    queryset = tblSchedule.objects.all()
    serializer_class = tblScheduleSerializer


class tblUpdateStatusViewSet(viewsets.ModelViewSet):
    queryset = tblUpdateStatus.objects.all()
    serializer_class = tblUpdateStatusSerializer


class tblProfileViewSet(viewsets.ModelViewSet):
    queryset = tblProfile.objects.all()
    serializer_class = tblProfileSerializer


class tblQuatationViewSet(viewsets.ModelViewSet):
    queryset = tblQuatation.objects.all()
    serializer_class = tblQuatationSerializer
